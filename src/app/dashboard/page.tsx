    ...
    <div className="space-y-10 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-border/40">
        ...
        <Dialog open={isUploadOpen} onOpenChange={setIsUploadOpen}>
          ...
          <DialogContent
            ...
            className="w-[calc(100vw-2rem)] max-w-3xl max-h-[92dvh] overflow-y-auto scrollbar-custom bg-[#141414] border border-border/40 text-foreground p-0 rounded-3xl shadow-2xl shadow-black/50 sm:w-full"
          >
      ...
      <Dialog open={isTuneOpen} onOpenChange={(open) => { setIsTuneOpen(open); if (!open) setEditingTrack(null) }}>
        <DialogContent
          onInteractOutside={(e) => e.preventDefault()}
          onEscapeKeyDown={(e) => e.preventDefault()}
          className="w-[calc(100vw-2rem)] max-w-2xl max-h-[90dvh] overflow-y-auto scrollbar-custom bg-[#141414] border border-border/40 text-foreground p-0 rounded-3xl shadow-2xl shadow-black/50 sm:w-full"
        >
          <DialogHeader className="sr-only">
