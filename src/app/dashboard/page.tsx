...
//   // 1. Adds brand new uploaded generation cards
...
//   // 2. Directly updates specific parameter profiles for existing targets
...
//             ...item, 
//             filterId, 
//             filter: filterNames[filterId] || "Noir", 
//             variant: variantName, 
...
//         id: track.id,
//         title: track.title,
//         filterId: track.filterId || "f-1",
//         variant: track.variant || "Variant Alpha"
//       })
//       setIsTuneOpen(true)
//     }
//   }
...
//       <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-b border-border/40">
//         <div>
...
//         {/* DIALOG ONE: Fresh Asset Pipeline Upload Stream */}
...
//             </Button>
//           </DialogTrigger>
//           <DialogContent className="sm:max-w-xl bg-[#121212] border border-border/40 text-foreground p-0 rounded-none overflow-hidden">
...
//       {/* DIALOG TWO: Standalone Quick Tuning Editor Panel View */}
//       <Dialog open={isTuneOpen} onOpenChange={(open) => { setIsTuneOpen(open); if(!open) setEditingTrack(null); }}>
//         <DialogContent className="sm:max-w-md bg-[#121212] border border-border/40 text-foreground p-0 rounded-none overflow-hidden">
//           <DialogHeader className="sr-only">
