...
//           <button onClick={() => setAuthDialogOpen(true)} className="px-4 py-2 border border-border rounded-full font-mono text-[12px] tracking-[0.2em] uppercase hover:bg-foreground hover:text-background transition-colors cursor-pointer">
//             Get Started
//           </button>
//         </div>
//       </nav>
...
//           </p>
//           <button onClick={() => setAuthDialogOpen(true)} className="w-full py-3.5 bg-foreground text-background font-mono text-[9px] tracking-[0.2em] uppercase hover:bg-accent hover:text-foreground transition-colors cursor-pointer">
//             Subscribe Now
//           </button>
//         </div>
//       </section>
...
//           </div>
//           <div className="pt-2">
//             <button onClick={() => setAuthDialogOpen(true)} className="px-10 py-4 bg-foreground text-background font-mono text-[9px] tracking-[0.25em] uppercase hover:bg-accent hover:text-foreground transition-colors cursor-pointer">
//               Get Started
//             </button>
//           </div>
//         </div>
        ...
        <div className="md:hidden fixed bottom-6 right-6 z-50">
          ...
          >
            <div className='flex flex-col gap-3'>
              ...
              <button
                onClick={() => { toggleDarkMode(); handleLinkClick(); }}
                className={linkClass}
